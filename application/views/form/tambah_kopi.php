                ...
                <div class="container col-md-10 ">
                    <div class="container col-md-9 ">
                        <div class="row">
                            ...
                            <form action="<?php echo site_url('C_data_kopi/proses_tambah_kopi');?>" method="post">


                            <div class="form-group col-lg-4 col-md-4 col-sm-4">
                                <label>Jenis Kopi</label>
                                <select class="form-control" name="jenis_kopi" value=""/>
                            ...
                            <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                <label>Asal Daerah Kopi</label>
                                <input name="daerah" type="text" class="form-control" required="required" placeholder="" value=""/>
                            </div>

                                <div class="form-group col-lg-12 col-md-12 col-sm-12">
                                    <label>Tanggal Masuk</label>
                                    <input name="tanggal" type="date" class="form-control ui-datepicker-buttonpane" required="required" placeholder="" value=""/>
                                </div>
