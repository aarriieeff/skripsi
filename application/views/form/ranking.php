                ...
                <div class="sidebar-nav">
                    <div class="nav-canvas">
                        ...
                        <ul class="nav nav-pills nav-stacked main-menu">
                            ...
                            <li><a class="ajax-link" href="<?php echo site_url('C_data_kopi/view_kopi1');?>"><i class="glyphicon glyphicon-bell"></i><span> Data Kopi</span></a>
                            </li>
            ...
            <div class='content'>
                <div class="container col-md-10 ">
                    <div class="container col-md-9 ">
                        <div class="row">
                            <center><h1><b> RANKING PENILAIAN KOPI </b></h1></center>
                            <br><br>
                            <br>
                            <center>
                                <table class="table table-striped">
                                    ...
                                    <fieldset>
                                        ...
                                        <tr>
                                            ...
                                            <td></td>
                                            <td>
                                                <a href="<?php echo site_url('Majelis/info_majelis/'.$rk->id);?>"><input type="button" class="btn btn-info" value="info"/></a>
                                            </td>
                                        </tr>
                                        <?php $no++;} ?>
                                </table>
