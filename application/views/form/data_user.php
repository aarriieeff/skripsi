        ...
        <div class="row">
                        ...
                        <ul class="nav nav-pills nav-stacked main-menu">
                            ...
                            <li class="accordion ">
                                ...
                                <ul class="nav nav-pills nav-stacked">
                                    ...
                                    <li><a href="#">Kelola Subkriteria Bobot</a></li>
            ...
            <div class='content'>
                <div class="container col-md-8 ">
                    <div class="row">
                        <center><h1><b> DATA ADMIN GKT JEMBER </b></h1></center>

                        <a href="<?php echo site_url('Nilai/reset_penilaian');?>" data-confirm="Apakah anda yakin akan mereset status penilaian Jemaat ?"><button class="btn btn-primary" id="btnTambah">Tambah User</button></a>
                        <br>
                        <center>
                            <?php
            ...
            <strong>Success!</strong> Data berhasil diproses.
                            ...
                            <table class="table table-striped">
                                ...
                                <?php foreach ($vuser as $mjl) {?>
                                <fieldset>

                                    <tr>
                                        <td><?php echo $mjl->username;?></td>
                                        <td><?php echo $mjl->password;?></td>
                                        <td><?php echo $mjl->level;?></td>
                                        <td>
                                            <a href="<?php echo site_url('User/delete_user/'.$mjl->id);?>" data-confirm="Apakah anda yakin akan menghapus data admin ?"><input type="button" class="btn btn-danger" value="Delete"/></a>
                                        </td>
                                    </tr>
                                    <?php } ?>
                            </table>
