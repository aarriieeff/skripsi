                ...
                <div class="sidebar-nav">
                    <div class="nav-canvas">
                        ...
                        <ul class="nav nav-pills nav-stacked main-menu">
                            ...
                            <li><a class="ajax-link" href="<?php echo site_url('C_halaman_operator/kriteria_mutu');?>"><i class="glyphicon glyphicon-book"></i><span> Kriteria Mutu Kopi</span></a>
                            </li>
                        ...
                        <div class="row">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <?php foreach ($dbview_kopi as $kopi) {?>
                                    <fieldset>
                                        <tr>
                                            <td><?php echo $kopi->id;?></td>
                                            <td><?php echo $kopi->jenis_kopi;?></td>
                                            <td><?php echo $kopi->daerah;?></td>
                                            <td><?php echo $kopi->tanggal;?></td>
                                            <td>
                                                <a href="" data-confirm="Apakah anda yakin akan menghapus data admin ?"><input type="button" class="btn btn-danger" value="Delete"/></a>
                                                <a href="" data-confirm="Apakah anda yakin akan menghapus data admin ?"><input type="button" class="btn btn-warning" value="edit"/></a>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                </table>
                                </fieldset>
                                <a href="<?php echo site_url('C_data_kopi/tambah_kopi');?>" class="btn btn-success " target="_blank">Tambah Baru</a>
