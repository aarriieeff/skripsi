        ...
        <div class="row">
            ...
            <div class='content'>
                <div class="container col-md-8 ">
                    <div class="row">
                        <center><h1><b> Edit Bobot </b></h1></center>
                        <form action="<?php echo site_url('C_halaman_admin/proses_edit_bobot/');?>" method="POST">
                            ...
                            <a href="<?php echo site_url('C_halaman_admin/view_bobot_kriteria/');?>"><button type="button" class="btn" style="float: right; margin: 2px;">Back</button></a>
                            <br />
                        </form>
                        <hr />
                        <br />
