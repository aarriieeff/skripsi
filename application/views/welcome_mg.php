                ...
                <div class="sidebar-nav">
                    <div class="nav-canvas">
                        ...
                        <ul class="nav nav-pills nav-stacked main-menu">
                            ...
                            <li><a class="ajax-link" href="<?php echo site_url('User/view_user');?>"><i class="glyphicon glyphicon-book"></i><span> Hasil Penilaian Kopi</span></a>
                            </li>
                ...
                <div class="container col-md-10 ">
                    <div style="margin-left:30%;margin-top:5%;" class="col-md-2  text-center">
                        ...
                        <div class="alert alert-info">
                            ...
                            <span class="label label-info" style="margin-right: 10px;">Welcome Manager</span>
                        </div>
                    </div>
                </div>
            </div>
